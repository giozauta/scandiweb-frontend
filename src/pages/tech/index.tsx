...
import { GET_TECH_PRODUCTS } from "@/graphql/queries/queris";
import ProductCard from "@/components/product-card";
import { Product } from "./types";

const Tech: React.FC = () => {
  const { data, loading, error } = useQuery(GET_TECH_PRODUCTS);
  ...
  return (
    <div className="mx-auto pt-10">
      <h1 className="text-2xl font-bold mb-6 text-gray-800">Tech</h1>
